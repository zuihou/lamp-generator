...
<#list cfg.filedTypes as type>
    <#list table.fields as field>
        <#if field.propertyName == type.name>
            import ${type.packagePath};
            <#break>
        </#if>
    </#list>
</#list>
...
<#-- 如果有父类，排除公共字段 -->
    <#if (superEntityClass?? && cfg.superExtend?? && field.propertyName !="id") || (superEntityClass?? && field.propertyName !="id" && field.propertyName !="createTime" && field.propertyName != "updateTime" && field.propertyName !="createUser" && field.propertyName !="updateUser") || !superEntityClass??>
        ...
        <#assign isEnumType="1"/>
        <#list cfg.filedTypes as filed>
            <#if filed.name == field.propertyName>
                <#assign myPropertyType="${filed.type}"/>
                <#assign isEnumType="2"/>
            </#if>
        </#list>
...
<#list table.fields as field><#assign myPropertyType="${field.propertyType}"/><#if field.customMap.dict??><#assign myPropertyType="Dictionary"/></#if><#list cfg.filedTypes as filed><#if filed.name == field.propertyName><#assign myPropertyType="${filed.type}"/></#if></#list><#if field_has_next>${((field_index + 1) % 6 ==0)?string('\r\n                    ', '')}${myPropertyType} ${field.propertyName}, <#else>${myPropertyType} ${field.propertyName}</#if></#list>) {
